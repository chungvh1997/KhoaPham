					...
					<div class="deal-leftmk left-side">
						...
						<div class="special-sec1">
							<div class="col-xs-4 img-deals">
								<img src="public/web/images/d2.jpg" alt="">
							</div>
						...
						<div class="special-sec1">
							<div class="col-xs-4 img-deals">
								<img src="public/web/images/d1.jpg" alt="">
							</div>
							<div class="col-xs-8 img-deal1">
						...
						<div class="special-sec1">
							<div class="col-xs-4 img-deals">
								<img src="public/web/images/d4.jpg" alt="">
							</div>
							<div class="col-xs-8 img-deal1">
								<h3>Tata Salt</h3>
						...
						<div class="special-sec1">
							<div class="col-xs-4 img-deals">
								<img src="public/web/images/d5.jpg" alt="">
							</div>
							<div class="col-xs-8 img-deal1">
						...
						<div class="special-sec1">
							<div class="col-xs-4 img-deals">
								<img src="public/web/images/d3.jpg" alt="">
							</div>
							<div class="col-xs-8 img-deal1">
				...
				<div class="agileinfo-ads-display col-md-9">
					<div class="wrapper">
						...
						<div class="product-sec1">
							...
							<!-- loadmore -->
							<div class="col-md-12 ">
							<div class="show_more_main" id="show_more_main<?=$product->id?>">
					...
					success:function(html){
						...
						<div class="product-sec1 product-sec2">
							...
							<div class="col-xs-5 bg-right-nut">
								<img src="public/web/images/nut1.png" alt="">
							</div>
							<div class="clearfix"></div>
						</div>
						<!-- //second section (nuts special) -->
						...
						<div class="product-sec1">
							...
							<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="public/web/images/mk4.jpg" alt="">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
							...
							<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="public/web/images/mk5.jpg" alt="">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
							...
							<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="public/web/images/mk6.jpg" alt="">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
						...
						<div class="product-sec1">
							...
							<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="public/web/images/mk7.jpg" alt="">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
							...
							<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="public/web/images/mk8.jpg" alt="">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
							...
							<div class="col-md-4 product-men">
								<div class="men-pro-item simpleCart_shelfItem">
									<div class="men-thumb-item">
										<img src="public/web/images/mk9.jpg" alt="">
										<div class="men-cart-pro">
											<div class="inner-men-cart-pro">
												<a href="single.html" class="link-product-add-cart">Quick View</a>
											</div>
					...
					<ul id="flexiselDemo1">
						<li>
							<div class="w3l-specilamk">
								<div class="speioffer-agile">
									<a href="single.html">
										<img src="public/web/images/s1.jpg" alt="">
									</a>
								</div>
						...
						<li>
							<div class="w3l-specilamk">
								<div class="speioffer-agile">
									<a href="single.html">
										<img src="public/web/images/s4.jpg" alt="">
									</a>
								</div>
								<div class="product-name-w3l">
									<h4>
						...
						<li>
							<div class="w3l-specilamk">
								<div class="speioffer-agile">
									<a href="single.html">
										<img src="public/web/images/s2.jpg" alt="">
									</a>
								</div>
								<div class="product-name-w3l">
									<h4>
						...
						<li>
							<div class="w3l-specilamk">
								<div class="speioffer-agile">
									<a href="single2.html">
										<img src="public/web/images/s3.jpg" alt="">
									</a>
								</div>
								<div class="product-name-w3l">
									<h4>
						...
						<li>
							<div class="w3l-specilamk">
								<div class="speioffer-agile">
									<a href="single.html">
										<img src="public/web/images/s8.jpg" alt="">
									</a>
								</div>
								<div class="product-name-w3l">
									<h4>
						...
						<li>
							<div class="w3l-specilamk">
								<div class="speioffer-agile">
									<a href="single2.html">
										<img src="public/web/images/s6.jpg" alt="">
									</a>
								</div>
								<div class="product-name-w3l">
									<h4>
						...
						<li>
							<div class="w3l-specilamk">
								<div class="speioffer-agile">
									<a href="single.html">
										<img src="public/web/images/s5.jpg" alt="">
									</a>
								</div>
								<div class="product-name-w3l">
									<h4>
						...
						<li>
							<div class="w3l-specilamk">
								<div class="speioffer-agile">
									<a href="single2.html">
										<img src="public/web/images/s9.jpg" alt="">
									</a>
								</div>
								<div class="product-name-w3l">
									<h4>
