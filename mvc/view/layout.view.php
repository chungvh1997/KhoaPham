...
Smartphone Compatible web template, free webdesigns for Nokia, Samsung, LG, SonyEricsson, Motorola web design" />
	...
	<!--//tags -->
	<link href="public/web/css/bootstrap.css" rel="stylesheet" type="text/css" media="all" />
	...
	<!--pop-up-box-->
	<link href="public/web/css/popuo-box.css" rel="stylesheet" type="text/css" media="all" />
	<!--//pop-up-box-->
	<!-- price range -->
	<link rel="stylesheet" type="text/css" href="public/web/css/jquery-ui1.css">
	<!-- fonts -->
...
<body>
			...
			<div class="col-md-4 logo_agile">
				<h1>
					<a href="index.html">
						<span>G</span>rocery
						<span>S</span>hoppy
						<img src="public/web/images/logo2.png" alt=" ">
					</a>
				</h1>
			</div>
			<!-- header-bot -->
								...
								<li class="dropdown">
									...
									<ul class="dropdown-menu multi-column columns-3">
										<div class="agile_inner_drop_nav_info">
											...
											<div class="col-sm-4 multi-gd-img">
												<img src="public/web/images/nav.png" alt="">
											</div>
											<div class="clearfix"></div>
										</div>
									</ul>
	...
	<div class="footer-top">
		<div class="container-fluid">
			...
			<div class="col-xs-4 w3l-rightmk">
				<img src="public/web/images/tab3.png" alt=" ">
			</div>
			<div class="clearfix"></div>
		</div>
	</div>
		...
		<div class="container">
			...
			<div class="footer-info w3-agileits-info">
				...
				<div class="col-sm-2 footer-grids  w3l-socialmk">
					...
					<div class="agileits_app-devices">
						...
						<a href="#">
							<img src="public/web/images/1.png" alt="">
						</a>
						<a href="#">
							<img src="public/web/images/2.png" alt="">
						</a>
						<div class="clearfix"> </div>
					</div>
				</div>
			...
			<div class="agile-sometext">
				...
				<div class="sub-some child-momu">
					...
					<ul>
						<li>
							<img src="public/web/images/pay2.png" alt="">
						</li>
						<li>
							<img src="public/web/images/pay5.png" alt="">
						</li>
						<li>
							<img src="public/web/images/pay1.png" alt="">
						</li>
						<li>
							<img src="public/web/images/pay4.png" alt="">
						</li>
						<li>
							<img src="public/web/images/pay6.png" alt="">
						</li>
						<li>
							<img src="public/web/images/pay3.png" alt="">
						</li>
						<li>
							<img src="public/web/images/pay7.png" alt="">
						</li>
						<li>
							<img src="public/web/images/pay8.png" alt="">
						</li>
						<li>
							<img src="public/web/images/pay9.png" alt="">
						</li>
					</ul>
				</div>
				<!-- //payment -->
	...
	<script src="public/web/js/jquery.magnific-popup.js"></script>
	<script>
	...
	<!-- cart-js -->
	<script src="public/web/js/minicart.js"></script>
	<script>
	...
	<script src="public/web/js/jquery.flexisel.js"></script>
	<script>
		$(window).load(function () {
	...
	<!-- smoothscroll -->
	<script src="public/web/js/SmoothScroll.min.js"></script>
	<!-- //smoothscroll -->

	<!-- start-smooth-scrolling -->
	<script src="public/web/js/move-top.js"></script>
	<script src="public/web/js/easing.js"></script>
	<script>
