...
?>               
<div class="m-content">
<form name="frm" method="post" action="index.php?post=posts&action=save&curPage=<?= $_REQUEST['curPage'] ?>&back=<?= $_REQUEST['back'] ?>&key=<?= $_REQUEST['key'] ?>" enctype="multipart/form-data" class="m-form m-form--fit m-form--label-align-right">
<div class="row">
    <div class="col-md-6">
        <!--begin::Portlet-->
