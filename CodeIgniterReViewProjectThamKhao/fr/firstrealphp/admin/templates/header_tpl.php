...
<div class="m-stack__item m-brand  m-brand--skin-dark ">
    <div class="m-stack m-stack--ver m-stack--general">
        <div class="m-stack__item m-stack__item--middle m-brand__logo">
            ...
            <img alt="" src="public/images/logo_default_dark.png">
            </a>  
        </div>
...
<!--             <li class="m-nav__item m-topbar__notifications m-topbar__notifications--img m-dropdown m-dropdown--large m-dropdown--header-bg-fill m-dropdown--arrow m-dropdown--align-center  m-dropdown--mobile-full-width" m-dropdown-toggle="click" m-dropdown-persistent="1">
    <a href="index.php?post=contact&action=man" class="m-nav__link m-dropdown__toggle" id="m_topbar_notification_icon">
    ...
    <div class="m-dropdown__wrapper">
        <span class="m-dropdown__arrow m-dropdown__arrow--center"></span>
        <div class="m-dropdown__inner">
            <div class="m-dropdown__header m--align-center" style="background: url(public/images/notification_bg.jpg); background-size: cover;">
                <span class="m-dropdown__header-title"><?=count($total_contact)?> New</span>
    ...
    <span class="m-topbar__userpic">    
        <img src="public/images/user4.jpg" class="m--img-rounded m--marginless" alt="">
    </span>
    ...
    <div class="m-dropdown__wrapper">
        ...
        <div class="m-dropdown__inner">
            <div class="m-dropdown__header m--align-center" style="background: url(public/images/user_profile_bg.jpg); background-size: cover;">
                <div class="m-card-user m-card-user--skin-dark">
                    ...
                    <div class="m-card-user__details">
                        ...
                        <a href="" class="m-card-user__email m--font-weight-300 m-link">info@vincity.vn</a>
                    </div>
                </div>
            </div>
            <div class="m-dropdown__body">
                <div class="m-dropdown__content">
                    <ul class="m-nav m-nav--skin-light">
                        ...
                        <li class="m-nav__item">
                            <a href="index.php?post=user&action=edit&id=1" class="m-nav__link">
                        ...
                        <li class="m-nav__item">
                            <a href="index.php?post=user&action=logout" class="btn m-btn--pill    btn-secondary m-btn m-btn--custom m-btn--label-brand m-btn--bolder">Logout</a>
                        </li>
                    </ul>
                </div>
            </div>
                ...
                <li id="m_quick_sidebar_toggle" class="m-nav__item">
                    <a href="index.php?post=dashboard&action=man" class="m-nav__link m-dropdown__toggle">
